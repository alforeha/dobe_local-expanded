...
const rawStarterTaskTemplates: TaskTemplate[] = [
  ...
  },
  {
    ...
    isSystem: true,
    isCustom: false,
    name: 'Explore the Schedule Habitats',
    description: 'System onboarding completion for opening the Schedule habitats (rehomed from the retired Task Room).',
    icon: 'task',
    taskType: 'CHECK',
    inputFields: { label: 'Explore the Schedule Habitats' },
    xpAward: noStatXp(),
    xpBonus: 0,
    secondaryTag: null,
    category: 'system',
